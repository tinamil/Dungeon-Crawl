...
public class SmartScroller implements AdjustmentListener {
  /**
   * monitor scrolling in the horizontal direction
   */
  public final static int HORIZONTAL      = 0;
  /**
   * (default) – monitor scrolling in the vertical direction
   */
  public final static int VERTICAL        = 1;

  /**
   * viewport is kept at the start of the scrollpane (ie. the top for vertical scrolling and the
   * left for horizontal scrolling)
   */
  public final static int START           = 0;
  /**
   * (default) – viewport is kept at the end of the scrollpane (ie. the bottom for vertical
   * scrolling and the right for horizontal scrolling)
   */
